@php
    $items = App\Models\Service::paginate(5)
...
<footer class="footer">
                    ...
                    <div class="single-widget widget-quicklinks">
                        ...
                        <ul>
                            @foreach ($items as $dropdownItem)
                                    <li>
                                        <a href="{{ $dropdownItem['url'] }}"  class="{{ active_class($dropdownItem['path']) }}">
                                            {{ $dropdownItem['label'] }}
                                        </a>
                                    </li>
                            @endforeach
    ...
    <div class="footer-bottomarea">
        <div class="container">
            <p class="footer-copyright">Copyright 2024 by <a href="{{ url('/') }}">{{ config('app.name') }}</a>.
