        ...
        <div class="tm-section products-area tm-padding-section bg-white">
            <div class="container">
                ...
                <div class="row product-slider-active tm-slider-arrow tm-slider-arrow-hovervisible">
                    @foreach (App\Models\Equipment::paginate(6) as $equipment)
                        <div class="col">
                            <div class="tm-product">
                                <div class="tm-product-image">
                                    <a class="tm-product-imagelink" href="{{ route('equipments', $equipment->slug) }}">
                                ...
                                <div class="tm-product-content">
                                    <h5 class="tm-product-title text-center">
                                        <a href="{{ route('equipments', $equipment->slug) }}">{{ $equipment->title }}</a>
                                    </h5>
                                    <h6 class="tm-product-price text-center">
                                        <a href="{{ route('equipments', $equipment->slug) }}">Read More</a>
                                    </h6>
                                </div>
                            </div>
                        </div>
